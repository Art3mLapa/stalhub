	...
	return (
		<>
			...
			<div className="relative z-9" ref={menuRef}>
				<div
					className={clsx(
						'absolute top-14 min-w-80 origin-top-left rounded-2xl bg-neutral-100 p-4 shadow-md ring-2 ring-border transition-all duration-300 ease-in-out dark:bg-neutral-950 dark:text-neutral-100',
						isMenuOpen
